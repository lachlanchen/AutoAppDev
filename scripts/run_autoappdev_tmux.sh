...
# Ensure the PWA points at the chosen backend port. This file is gitignored.
API_HOST="$BACKEND_HOST"
case "$API_HOST" in
  0.0.0.0|::|::0) API_HOST="127.0.0.1" ;;
esac
cat >"$ROOT_DIR/pwa/config.local.js" <<EOF
// Auto-generated by scripts/run_autoappdev_tmux.sh
...
echo "PWA API base:       http://$API_HOST:$BACKEND_PORT"
