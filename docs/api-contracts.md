...
```json
{
  ...
  "line": 1,
  "detail": "expected header: AUTOAPPDEV_PIPELINE 1"
}
```
...
```json
{
  ...
  "line": 1,
  "detail": "expected at least one \"# AAPS:\" annotation line"
}
```
...
{
  "ok": false,
  "error": "missing_philosophy",
  "detail": "block_markdown must include a '## Philosophy' section"
}
```
...
```json
{
  ...
  "detail": "expected exactly one begin+end marker; got begin=1 end=0"
}
```
