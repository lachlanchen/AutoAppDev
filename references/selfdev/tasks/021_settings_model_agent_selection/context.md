...
- task_seq: 21
- task_slug: settings_model_agent_selection
- area: pwa
- title: Settings for agent/model selection
- acceptance: Settings panel lets user pick agent/model options (persisted via backend); selection survives reload
