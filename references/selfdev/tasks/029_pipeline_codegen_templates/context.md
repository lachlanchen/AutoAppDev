...
- task_seq: 29
- task_slug: pipeline_codegen_templates
- area: scripts
- title: Codegen templates for runnable drivers
- acceptance: Repo includes a script/template that generates a runnable shell driver from IR (Codex non-interactive calls + reusable actions); generation is deterministic
