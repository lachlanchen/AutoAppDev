...
- task_seq: 34
- task_slug: pwa_update_readme_block
- area: pwa
- title: Add Update README block to palette
- acceptance: PWA adds an Update README block and exports it into the formatted script/IR; UI makes clear which workspace README it targets
