...
- task_seq: 18
- task_slug: blocks_to_plan_payload
- area: pwa
- title: Convert blocks to pipeline plan payload
- acceptance: Workspace JSON can be transformed into a backend-recognized plan payload; add a UI button that posts the plan to backend and gets an ack
