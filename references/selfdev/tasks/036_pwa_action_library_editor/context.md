...
- task_seq: 36
- task_slug: pwa_action_library_editor
- area: pwa
- title: Action library editor UI
- acceptance: PWA can list/create/edit action definitions (prompt template, agent/model, or command/script reference) and persists changes via backend without reload
