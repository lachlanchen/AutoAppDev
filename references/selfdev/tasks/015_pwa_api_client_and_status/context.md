...
- task_seq: 15
- task_slug: pwa_api_client_and_status
- area: pwa
- title: PWA API client + status badges
- acceptance: PWA has a small API client module; shows health, DB status, and pipeline state badge; updates at least every 2 seconds or via push
