...
- task_seq: 25
- task_slug: pipeline_script_parser_v0
- area: backend
- title: Parse formatted script into IR
- acceptance: Backend implements a deterministic parser for the standardized formatted script into IR; invalid input returns actionable errors and never executes code
