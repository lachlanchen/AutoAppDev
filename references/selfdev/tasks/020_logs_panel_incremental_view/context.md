...
- task_seq: 20
- task_slug: logs_panel_incremental_view
- area: pwa
- title: Logs view panel
- acceptance: Logs panel polls or streams incremental logs and auto-scrolls with a pause toggle; user can copy selected text
