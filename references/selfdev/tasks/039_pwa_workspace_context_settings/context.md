...
- task_seq: 39
- task_slug: pwa_workspace_context_settings
- area: pwa
- title: Workspace/context settings UI
- acceptance: PWA lets the user select a workspace, set materials path, edit shared context, and choose a default language; settings persist and are used when generating scripts/prompts
