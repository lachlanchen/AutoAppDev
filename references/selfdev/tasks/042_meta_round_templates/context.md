...
- task_seq: 42
- task_slug: meta_round_templates
- area: docs
- title: Meta-round pipeline templates
- acceptance: Docs define a standard multi-round pipeline template: for N_ROUND generate/refine tasks from goal+context, then for each task run a configurable action template (plan/work/debug/fix/translate/summary/log/commit)
