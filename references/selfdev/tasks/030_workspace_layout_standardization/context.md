...
- task_seq: 30
- task_slug: workspace_layout_standardization
- area: docs
- title: Standardize workspace folders + contracts
- acceptance: Docs define standard folders (materials/interactions/outputs/docs/references/scripts/tools/logs/auto-apps) and how AutoAppDev uses them; includes a simple init checklist
