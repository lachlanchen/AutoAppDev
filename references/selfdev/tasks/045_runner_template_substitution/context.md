...
- task_seq: 45
- task_slug: runner_template_substitution
- area: scripts
- title: Runner: placeholder substitution
- acceptance: Generated runners apply deterministic placeholder substitution for `codex_exec.prompt` and `run.cmd` (task/step ids + task list fields + runtime_dir) and document the supported keys; include a smoke check
