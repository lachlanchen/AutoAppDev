...
- task_seq: 38
- task_slug: workspace_materials_and_context_api
- area: backend
- title: Workspace materials + shared context API
- acceptance: Backend stores per-workspace config (materials path(s), shared context text/file reference, default language) with safe path rules (under auto-apps/) and exposes read/write endpoints
