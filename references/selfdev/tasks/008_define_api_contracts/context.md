...
- task_seq: 8
- task_slug: define_api_contracts
- area: docs
- title: API contract doc
- acceptance: Docs list request/response shapes for: inbox messages, pipeline controls, logs, and settings; includes example JSON payloads
