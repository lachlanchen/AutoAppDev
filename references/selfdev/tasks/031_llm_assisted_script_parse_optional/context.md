...
- task_seq: 31
- task_slug: llm_assisted_script_parse_optional
- area: backend
- title: LLM-assisted parse fallback (optional)
- acceptance: Backend provides an optional endpoint that uses Codex (non-interactive) to convert arbitrary pipeline scripts into IR; runs with strict guardrails and timeouts, and stores provenance + prompts
