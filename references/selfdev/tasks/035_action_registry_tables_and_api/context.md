...
- task_seq: 35
- task_slug: action_registry_tables_and_api
- area: backend
- title: Action registry DB + CRUD API
- acceptance: Backend stores action definitions in Postgres (prompt- and command-based) and exposes minimal CRUD endpoints with validation and safe defaults
