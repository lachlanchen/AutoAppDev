...
- task_seq: 40
- task_slug: pwa_i18n_language_pack
- area: pwa
- title: Multilingual UI support
- acceptance: PWA supports runtime language switching with a built-in language pack: zh-Hans, zh-Hant, en, ja, ko, vi, ar (RTL), fr, es; default remains light theme
