...
- task_seq: 48
- task_slug: pwa_numbered_aaps_export
- area: pwa
- title: PWA: export/import numbered AAPS
- acceptance: Script panel exports numbered+indented AAPS lines and import tolerates optional numeric prefixes; UI renders numbering/indent for readability without changing semantics
