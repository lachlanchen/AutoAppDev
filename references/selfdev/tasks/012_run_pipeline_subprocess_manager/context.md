...
- task_seq: 12
- task_slug: run_pipeline_subprocess_manager
- area: backend
- title: Subprocess manager for pipeline
- acceptance: Backend can start the driver/pipeline as a subprocess, stop it, and detect exit; no orphan processes after stop
