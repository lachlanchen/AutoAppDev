...
- task_seq: 41
- task_slug: pipeline_chat_outbox_channel
- area: backend
- title: Pipeline outbox/messages channel
- acceptance: Backend provides a safe way for pipelines to write messages/status back to the UI (DB and/or runtime/outbox files) and the PWA can display them
