...
- task_seq: 43
- task_slug: aaps_numbering_placeholders_spec
- area: docs
- title: Numbered/indented AAPS + placeholders
- acceptance: Docs define a Scratch-like, numbered+indented AAPS convention (still AAPS v1-compatible) and a minimal placeholder syntax (e.g. {{task.title}}, {{task.acceptance}}, {{runtime_dir}}) used in prompts/cmds; includes at least one complete example script using meta_round_v0 + conditional fix steps
