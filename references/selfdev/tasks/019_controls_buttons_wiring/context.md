...
- task_seq: 19
- task_slug: controls_buttons_wiring
- area: pwa
- title: Start/stop/pause/resume buttons
- acceptance: Buttons call the pipeline control endpoints; UI disables invalid actions based on current state and shows error text on 400
