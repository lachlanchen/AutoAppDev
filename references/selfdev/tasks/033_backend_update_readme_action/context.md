...
- task_seq: 33
- task_slug: backend_update_readme_action
- area: backend
- title: Implement update_readme action endpoint
- acceptance: Backend exposes a safe endpoint to patch a workspace README between markers; rejects paths outside auto-apps/ and logs changes
