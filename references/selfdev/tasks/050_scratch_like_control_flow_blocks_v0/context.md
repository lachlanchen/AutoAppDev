...
- task_seq: 50
- task_slug: scratch_like_control_flow_blocks_v0
- area: pwa
- title: Scratch control-flow blocks v0
- acceptance: Add control-flow blocks: metatasks generator, For N_ROUND, For each task, If/Else; default canvas shows nested two-for template; export/import round-trips via AAPS+IR
