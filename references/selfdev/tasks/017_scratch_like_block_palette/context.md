...
- task_seq: 17
- task_slug: scratch_like_block_palette
- area: pwa
- title: Block palette + draggable blocks
- acceptance: PWA renders a minimal block palette (3-6 blocks) and supports dragging blocks into a workspace; workspace serializes to JSON
