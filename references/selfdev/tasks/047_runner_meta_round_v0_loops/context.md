...
- task_seq: 47
- task_slug: runner_meta_round_v0_loops
- area: scripts
- title: Runner: meta_round_v0 loops
- acceptance: Generated runners implement meta_round_v0: run controller round steps, read `task_list_path` JSON, then loop tasks and apply a template task (`TASK.meta.task_template_v0`) with placeholder substitution; persist resume state under runtime so reruns skip completed tasks
