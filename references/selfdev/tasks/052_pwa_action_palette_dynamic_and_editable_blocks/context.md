...
- task_seq: 52
- task_slug: pwa_action_palette_dynamic_and_editable_blocks
- area: pwa
- title: Dynamic palette + editable blocks
- acceptance: PWA toolbox is generated from Action library + built-ins; user-created actions appear as draggable blocks; blocks are editable (binding + parameters); editing a built-in action clones then edits the clone
