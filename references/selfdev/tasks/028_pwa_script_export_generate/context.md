...
- task_seq: 28
- task_slug: pwa_script_export_generate
- area: pwa
- title: Export formatted script + generate runner
- acceptance: PWA can export the current blocks/IR as the standardized formatted script and a generated runnable shell driver; outputs are downloadable as files
