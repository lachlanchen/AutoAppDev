...
- task_seq: 32
- task_slug: common_action_update_readme_spec
- area: docs
- title: Common action: update_readme spec
- acceptance: Docs define an `update_readme` ACTION (markers + philosophy section) and how it targets a workspace README under auto-apps/ without arbitrary path writes
