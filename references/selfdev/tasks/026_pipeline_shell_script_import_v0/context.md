...
- task_seq: 26
- task_slug: pipeline_shell_script_import_v0
- area: backend
- title: Best-effort import from shell script
- acceptance: Backend can import an annotated shell pipeline script (e.g. via structured comments) into IR with clear limitations; at least one example imports successfully
