...
- task_seq: 14
- task_slug: pwa_shell_light_theme
- area: pwa
- title: Light theme PWA shell
- acceptance: PWA loads offline-friendly shell with a clean light theme; includes top bar, left blocks palette, center workspace, right inspector/logs panel
