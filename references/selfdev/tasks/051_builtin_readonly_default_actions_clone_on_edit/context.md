...
- task_seq: 51
- task_slug: builtin_readonly_default_actions_clone_on_edit
- area: backend
- title: Built-in default actions + clone-on-edit
- acceptance: Backend exposes built-in default actions (including multilingual support) marked readonly; update/delete rejected; provide a clone endpoint so the UI can create an editable copy when the user tries to edit a built-in
