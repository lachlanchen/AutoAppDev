...
- task_seq: 22
- task_slug: end_to_end_happy_path_demo
- area: docs
- title: End-to-end demo checklist
- acceptance: Docs include a deterministic manual test: start backend, apply schema, open PWA, send inbox msg, drag blocks, start pipeline, see logs, pause/resume, stop
