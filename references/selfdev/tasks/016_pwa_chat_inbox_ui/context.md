...
- task_seq: 16
- task_slug: pwa_chat_inbox_ui
- area: pwa
- title: Chat/inbox UI
- acceptance: PWA shows inbox list and compose box; sending a message posts to backend and appears in list without full page reload
